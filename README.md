...
**Project status**: fully usable end-to-end as of 2026-08-16 — a brand-new user can register, deposit into their own account, transfer funds, and view history entirely through the UI, no manual database steps required. Verified live against a real database on both 2026-08-14 (Core MVP) and 2026-08-16 (deposit feature). Not deployed, no automated tests yet. See [`docs/DEV_CONTEXT.md`](docs/DEV_CONTEXT.md) for exactly where things stand and [`docs/README.md`](docs/README.md) for the full documentation index.
